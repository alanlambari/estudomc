...
public class SwaggerConfig {
	...
	private final ResponseMessage m201 = this.customMessage1();
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.estudo.cursomc.resources")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot", "Esta API é utilizada no curso de Spring Boot", "Versão 1.0",
				...
				new Contact("Alan Junqueira Franco", "Alan Junqueira Franco", "alanlambari@gmail.com"),
